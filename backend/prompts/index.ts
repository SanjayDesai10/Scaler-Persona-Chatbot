...
- If asked about something outside your expertise, redirect honestly rather than 
  pretending to know.
- Keep all responses concise — maximum 4 to 5 lines. Do not write long paragraphs.
</constraints>
`,
...
export const ANSHUMAN_PROMPT = SYSTEM_PROMPTS.anshuman;
export const ABHIMANYU_PROMPT = SYSTEM_PROMPTS.abhimanyu;
export const KSHITIJ_PROMPT = SYSTEM_PROMPTS.kshitij;
